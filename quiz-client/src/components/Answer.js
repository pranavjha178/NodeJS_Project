                    ...
                    <AccordionDetails sx={{ backgroundColor: grey[900] }}>
                        ...
                        <List>
                            {/* {item.options.map((x, i) =>
                                ...
                                <ListItem key="1">
                                    <Typography {...markCorrectOrNot(item, 1)}>
                                        <b>{String.fromCharCode(65) + ". "}</b>{item.Option1}
                                    </Typography>
                                </ListItem>
                                <ListItem key="2">
                                    <Typography {...markCorrectOrNot(item, 2)}>
                                        <b>B. </b>{item.Option2}
                                    </Typography>
                                </ListItem>
                                <ListItem key="3">
                                    <Typography {...markCorrectOrNot(item, 3)}>
                                        <b>C. </b>{item.Option3}
                                    </Typography>
                                </ListItem>
                                <ListItem key="4">
                                    <Typography {...markCorrectOrNot(item, 4)}>
                                        <b>D. </b>{item.Option4}
                                    </Typography>
                                </ListItem>
                        </List>
